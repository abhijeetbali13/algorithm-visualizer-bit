...
export default function ActivitySelection() {
  ...
  const META = getAlgoMeta('activity-selection');
  ...
  return (
    <div className="algo-page">
      <div className="page-wrapper">
        ...
        <AlgoTabWrapper algoId="activity-selection" meta={META} steps={steps||[]} stepIdx={stepIdx||-1} currentMsg={current?.msg||''} onJumpTo={jumpTo}>
